           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a href="tampiladminsar"><i class="fa fa-dashboard fa-3x"></i> Tugas</a>
                    </li>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $row['triase']?></td>
                                            <td>
                                        <a class="btn btn-danger float-left ml-1" href="<?php echo base_url()."index.php/far_controller/do_deletekorban/".$row['id_korban']; ?>" onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?');">Hapus</a>
                                        </td>
                                        </tr>
                                    <?php } ?>
                                ...
                                <div class="container">
          <a class="btn btn-primary " href="<?php echo base_url()."index.php/far_controller/add_datakorban"; ?>">Tambah Data</a>
