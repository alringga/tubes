                ...
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                        ...
                        <strong>  New User ? Register Yourself </strong>  
                            ...
                            <div class="panel-body">
                                <form role="form" method="post" action="registersar"><br/>
                                     ...
                                     <button  type="submit" class="btn btn-success ">Register Me
                                     </button>
                                    <hr />
                                    Already Registered ?  <a href="tampilLoginSar" >Login here</a>
                                    </form>
                            </div>
