...
<a href="index" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2><center>Tambah Korban</center></h2>   
                     <br>
      ...
      <form style="padding-left: 20px; padding-right: 20px;" method="POST" action="<?php echo base_url()."index.php/far_controller/do_insert"; ?>">
       ...
       <div class="form-group">
        ...
        <div class="form-group">
          <label> Triase</label>
          <input type="text" name="triase" class="form-control" required>
        </div>
        <div>
