                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                              ...
                                              <a class="btn btn-danger float-left ml-1" href="<?php echo base_url()."index.php/far_controller/do_deletealatsar/".$row['id_alat']; ?>" onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?');">Hapus</a>
                                            </td>
                                        </tr>
                                         <?php } ?>
                                    </tbody>
